...
public class APIClient {
    ...
    private static final String BASE_URL = "http://52.15.188.41/have_a_look/public/index.php/";

    static final String Images_BASE_URL = "http://52.15.188.41/have_a_look/images/";
